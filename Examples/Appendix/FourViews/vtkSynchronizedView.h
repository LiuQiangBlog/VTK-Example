...
class vtkCornerChineseAnnotation;
...
class vtkSynchronizedView : public vtkObject
{
  ...
  */
  vtkGetObjectMacro (CornerAnnotation, vtkCornerChineseAnnotation);
 ...
 private:
  ...
  vtkCornerChineseAnnotation*            CornerAnnotation;
